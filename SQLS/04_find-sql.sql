...
-- 유저 댓글 정보
SELECT R.REPLY_NO, R.REPLY_TYPE_NO, RT.REPLY_TYPE, R.REPLY_TARGET_NO, R.REPLY_CONTENT,
    CASE
...
LEFT JOIN BOARD B ON R.REPLY_TYPE_NO = 1 AND R.REPLY_TARGET_NO = B.BAORD_NO -- 일반게시물 (다이어리, 챌린지)
