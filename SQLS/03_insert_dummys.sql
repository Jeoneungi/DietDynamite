...
-- 6. 운동데이터(임시)
INSERT INTO WORKOUT (WORKOUT_NO, WORKOUT_NAME, WORKOUT_TYPE, WORKOUT_CLASS, WORKOUT_MET, WORKOUT_ST_TYPE, WORKOUT_CNT)
VALUES (SEQ_WORKOUT_NO.NEXTVAL, '바벨 스쿼트', 1, '근력', 6, 6, 500);

INSERT INTO WORKOUT (WORKOUT_NO, WORKOUT_NAME, WORKOUT_TYPE, WORKOUT_CLASS, WORKOUT_MET, WORKOUT_ST_TYPE, WORKOUT_CNT)
VALUES (SEQ_WORKOUT_NO.NEXTVAL, '다트', 1, '기타', 2.5, 7, 200);

INSERT INTO WORKOUT (WORKOUT_NO, WORKOUT_NAME, WORKOUT_TYPE, WORKOUT_CLASS, WORKOUT_MET, WORKOUT_ST_TYPE, WORKOUT_CNT)
VALUES (SEQ_WORKOUT_NO.NEXTVAL, '야구 캐치볼', 1, '기타', 2.5, 7, 10);

INSERT INTO WORKOUT (WORKOUT_NO, WORKOUT_NAME, WORKOUT_TYPE, WORKOUT_CLASS, WORKOUT_MET, WORKOUT_ST_TYPE, WORKOUT_CNT)
VALUES (SEQ_WORKOUT_NO.NEXTVAL, '당구', 1, '스포츠', 2.5, 7, 100);
