...
CREATE TABLE "REPLY_TARGET"(
	"REPLY_TYPE_NO" NUMBER CONSTRAINT PK_REPLY_TYPE_NO PRIMARY KEY,
	"REPLY_TYPE" VARCHAR2(40) NOT NULL
);

COMMENT ON COLUMN "REPLY_TARGET"."REPLY_TYPE_NO" IS '게시글 타입 번호 ';
COMMENT ON COLUMN "REPLY_TARGET"."REPLY_TYPE" IS '게시글 타입 이름 ';
...
CREATE TABLE "REPLY"(
	...
	"REPLY_TYPE_NO" NUMBER CONSTRAINT FK_REPLY_REPLY_TYPE_NO REFERENCES REPLY_TARGET(REPLY_TYPE_NO) NOT NULL,
...
COMMENT ON COLUMN "REPLY"."REPLY_TARGET_NO" IS '댓글 번호';
