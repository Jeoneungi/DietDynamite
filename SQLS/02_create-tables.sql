...
COMMENT ON COLUMN "USER_HISTORY"."LOGIN_DT" IS '유저IP(v4)';

CREATE SEQUENCE PK_HISTORY_NO NOCACHE;
-- ========================================================================================================
...
CREATE SEQUENCE PK_RECIPE_NO NOCACHE;
...
CREATE TABLE "WORKOUT_TYPE" (
	"WORKOUT_TYPE_NO"	NUMBER	CONSTRAINT PK_WORKOUT_TYPE PRIMARY KEY,
	"WORKOUT_TYPE_NAME"	VARCHAR2(120) NOT NULL
);

COMMENT ON COLUMN "WORKOUT_TYPE"."WORKOUT_TYPE_NO" IS '운동 통계 타입 번호';

COMMENT ON COLUMN "WORKOUT_TYPE"."WORKOUT_TYPE_NAME" IS '통계 타입 이름';
...
CREATE TABLE "WORKOUT" (
	...
	"WORKOUT_TYPE_NO" NUMBER NOT NULL,
	"WORKOUT_CNT" NUMBER DEFAULT 0 NOT NULL,
     CONSTRAINT FK_WORKOUT_TYPE_NO FOREIGN KEY (WORKOUT_TYPE_NO) REFERENCES WORKOUT_TYPE (WORKOUT_TYPE_NO)
...
COMMENT ON COLUMN "WORKOUT"."WORKOUT_TYPE_NO" IS '운동 통계 타입 번호';
...
ALTER TABLE "CHALLENGE_LIST" ADD CONSTRAINT "PK_CHALLENGE_LIST" PRIMARY KEY
("CHALLENGE_NO");
...
COMMENT ON COLUMN "CHALLENGE"."CHALLENGE_SATAR_DAY" IS '챌린지시작일';
...
ALTER TABLE "CHALLENGE" ADD CONSTRAINT "FK_CHALLENGE_LIST_TO_CHALLENGE_1" FOREIGN KEY (
	"CHALLENGE_NO"
)
REFERENCES "CHALLENGE_LIST" (
	"CHALLENGE_NO"
);
