...
<footer class="base__lorange">
    <div class="footer-top d-flex">
        ...
        <!-- 채팅 탭 생성 버튼-->
        <div class="chatting-btn-container">
            <button class="btn-exsmall__lorange chatting-btn" onclick="showChattingTab()">채팅 + </button>
        </div>
        <!-- 채팅 탭 생성 -->
        ...
        <div class="footer-top-left d-flex">
            <div class="footer-top-anno d-flex">
                <p class="fs-14__ex fc__white mr-10"> 공지사항 </p>
                <p class="fs-14 fc__white text-hover__gray"> KH 커뮤니티 페이지가 오픈했습니다! </p>
            </div>
        </div>
    ...
    <div class="footer-bot d-flex">
        ...
        <p class="footer-bot-warn fc__white"> 본 콘텐츠의 저작권은 제공처 또는 DD조에 있으며, 이를 무단 이용하는 경우 저작권법 등에 따라 법적 책임을 질 수 있습니다.
        </p>
    </div>
</footer>