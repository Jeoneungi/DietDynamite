            ...
            <div class="diaryInfo">
              ...
              <c:if test="${!empty totalIntake || !empty totalBurned}">
                <div class="section">
                  ...
                  <div class="item">
                    <div class="item-1">
                      <span class="fs-12__b" style="width : 50px">섭취</span>
                      <span class="item-content">${totalIntake} Kcal</span>
                    </div>
                    <div class="item-1">
                      <span class="fs-12__b" style="width : 50px">소모</span>
                      <span class="item-content">${totalBurned} Kcal</span>
                    </div>
                    <div class="item-1">
                      <span class="fs-12__b" style="width : 50px">누적</span>
                  ...
                  <c:if test="${!empty weightGain || !empty weightLoss || !empty expectedWeightChange}">
                    ...
                    <div class="item">
                      <div class="item-1">
                        ...
                        <span class="item-content-1">${expectedWeightChange} kg</span>
                      </div>
                    </div>
                  </c:if>
