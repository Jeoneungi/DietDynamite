...
<header>
		...
		<div class="header-top">
	        <div class="header-top-user box-hover dropdown">
	            ...
	            <ul class="dropdown-menu">
	                ...
	                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/profile/myComment">내 댓글</a></li>
	                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/profile/myComment">내 게시글</a></li>
	                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/profile/myComment">내 스크랩</a></li>
	                
	                <p class="header-title fc__gray fs-20__b"> 개인 정보 </p>
	                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/profile/myInfo">내 정보 관리</a></li>
	            	...
	            	<c:if test="${loginUser.getUserAuthority() == 'A' }">
		                ...
		                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/admin/profile/userManagement">유저 관리</a></li>
		                <li><a class="dropdown-item fs-20__b text-hover__blue" href="/admin/profile/reportManagement">신고 관리</a></li>
					</c:if>
	            	<li>
    ...
    <div class="header-bot d-flex linear_orange">
        ...
        <div class="header-nav">
       		<ul class="d-flex">
	         	<li>
	              <a class="fs-20 fc__white text-hover__white" href="#">커뮤니티</a>
	         	</li>
	         	<li>
	              <a class="fs-20 fc__white text-hover__white" href="#">기능</a>
	         	</li>
	         	<li>
	              <a class="fs-20 fc__white text-hover__white" href="#">지도</a>
	         	</li>
	         	<li>
	              <a class="fs-20 fc__white text-hover__white" href="#">정보마당</a>
	         	</li>
      		</ul>
        </div>
    </div>
